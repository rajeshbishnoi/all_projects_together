...
<div class="" style="text-align: center;margin-top: 5%;">
	{!! Form::open(['url' => 'foo/bar']) !!}
   		...
   		{!! Form::label('Name','', array('class' => '','placeholder' => '' )) !!}<br>

   		
   		{!! Form::text('name','', array('class' => ' center','placeholder' => '' )) !!}<br><br>
      ...
      {!! Form::label('Phone','', array('class' => '','placeholder' => '' )) !!}<br>
      
      {!! Form::text('Phone','', array('class' => 'center','placeholder' => '' )) !!}<br><br>

       {!! Form::submit('Back','', array('class' => 'btn btn-success','placeholder' => '' )) !!}

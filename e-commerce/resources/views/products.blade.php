					...
					<div class="container">
						<div class="product-agileinfo-grids w3l">
							<div class="col-md-3 product-agileinfo-grid">
											...
											<ul>
												<li><input type="checkbox" id="item-0-0" /><label for="item-0-0">Ethnic Wear</label>
													<ul>
														...
														<li><a href="{{ URL('/products') }}">Caps</a></li>
														<li><a href="{{ URL('/products') }}">Shoes</a></li>
														<li><a href="{{ URL('/products') }}">Pants</a></li>
														<li><a href="{{ URL('/products') }}">SunGlasses</a></li>
														<li><a href="{{ URL('/products') }}">Trousers</a></li>
													</ul>
												</li>
								...
								<div class="top-rates">
									...
									<div class="recent-grids">
										<div class="recent-left">
											<a href="single.html"><img class="img-responsive " src="{{ URL::asset('public/images/r.jpg') }}" alt=""></a>	
										</div>
									...
									<div class="recent-grids">
										<div class="recent-left">
											<a href="single.html"><img class="img-responsive " src="{{ URL::asset('public/images/r1.jpg') }}" alt=""></a>	
										</div>
										<div class="recent-right">
											<h6 class="best2"><a href="{{ URL('/single') }}">Duis aute irure </a></h6>
									...
									<div class="recent-grids">
										<div class="recent-left">
											<a href="single.html"><img class="img-responsive " src="{{ URL::asset('public/images/r2.jpg') }}" alt=""></a>	
										</div>
										<div class="recent-right">
											<h6 class="best2"><a href="{{ URL('/single') }}">Lorem ipsum dolor </a></h6>
									...
									<div class="recent-grids">
										<div class="recent-left">
											<a href="single.html"><img class="img-responsive " src="{{ URL::asset('public/images/r3.jpg') }}" alt=""></a>	
										</div>
										<div class="recent-right">
											<h6 class="best2"><a href="{{ URL('/single') }}">Ut enim ad minim </a></h6>
								...
								<div class="cat-img">
									<img class="img-responsive " src="{{ URL::asset('public/images/45.jpg') }}" alt="">
								</div>
							</div>
							<div class="col-md-9 product-agileinfon-grid1 w3l">
								<div class="product-agileinfon-top">
									<div class="col-md-6 product-agileinfon-top-left">
										<img class="img-responsive " src="{{ URL::asset('public/images/img1.jpg') }}" alt="">
									</div>
									<div class="col-md-6 product-agileinfon-top-left">
										<img class="img-responsive " src="{{ URL::asset('public/images/img2.jpg') }}" alt="">
									</div>
									<div class="clearfix"></div>
								</div>
